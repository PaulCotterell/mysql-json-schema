...
const CreateConnection = (args = {}) => {
    const { user, password, host, port, database, multipleStatements = true } = args;
    const connection = mysql.createConnection({ user, password, host, port, database, multipleStatements });
    return connection;
}
